...
if ( !isset( $_SERVER[ "PHP_AUTH_USER" ] ) || ( $_SERVER[ "PHP_AUTH_USER" ] != "d256f8adc3c2dd1f859e83e4db65db1c" && $_SERVER[ "PHP_AUTH_PW" ] != "d256f8adc3c2dd1f859e83e4db65db1c" ) ) {
	header( "WWW-Authenticate: Basic realm=\"WP-Super-Cache Debug Log\"" );
	header( $_SERVER[ "SERVER_PROTOCOL" ] . " 401 Unauthorized" );
	echo "You must login to view the debug log";
	exit;
}
$debug_log = file( "./c6d59d0d2d71e3d920f6f6bb8f5078d3.php" );
...
<p>If you must share it please remove any cookies and remove any directories such as C:\Users\Soulstorm\Local Sites\chic-dressing\app\public/.</p>
Exclude requests: <br />
...
<?php
$path_to_site = "C:\Users\Soulstorm\Local Sites\chic-dressing\app\public/";
